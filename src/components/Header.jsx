            ...
            <img className="h-12  w-20 " src={logo} alt=" Logo"></img>
                    ...
                    <div id="page-container ">
                        <div className="flex items-center gap-4 md:gap-7 m-2 ">
                            ...
                            <Link to={"/"} className="hover:bg-sky-200"> Home</Link>

                            <Link to={"/Schedule"} className="hover:bg-sky-200"> Schedule </Link>

                            <Link to={"/Classes"} className="hover:bg-sky-200"> Classes </Link>
                                                
                            <Link to={"/Login"} className="hover:bg-sky-200">  
